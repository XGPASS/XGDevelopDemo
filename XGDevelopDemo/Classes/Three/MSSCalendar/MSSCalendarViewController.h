...
// 显示vc的方式
typedef NS_ENUM(NSInteger, MSSCalendarShowType) {
  MSSCalendarShowTypeIsPush,    // nav的push
  MSSCalendarShowTypeIsPresent, // 模态
};
...
@property (nonatomic, assign) MSSCalendarShowType showType; //显示vc的方式
